...
[![My Skills](https://skillicons.dev/icons?perline=9&i=vite,nextjs,nodejs,react,html,css,js,ts,webflow,figma,vercel,vscode,npm,threejs,github,git,gitlab,netlify,androidstudio,markdown,apple,windows,java,tailwindcss,powershell,bootstrap,python,cpp,c,postman&theme=dark)](https://skillicons.dev) 
